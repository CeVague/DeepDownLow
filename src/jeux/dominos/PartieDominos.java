...
public class PartieDominos {
	...
	public static void main(String[] args) {
		...
		AlgoJoueur[0] = new NegAlphaBeta(HeuristiquesDominos.hblanc, jBlanc, jNoir, 1); // Il faut remplir la méthode !!!
		AlgoJoueur[1] = new NegAlphaBeta(HeuristiquesDominos.hnoir , jNoir, jBlanc, 6); // Il faut remplir la méthode !!!
		
		// MinMax : 1-4 Rapide, 5 Limite (2 minutes)
		// Premier coup : 96739280 feuilles ont été visitées, ainsi que 2524544 noeuds.
		
		// AlphaBeta : 1-7 Rapide, 8 Limite (2 minutes)
		// Premier coup : 103173238 feuilles ont été visitées, ainsi que 7937230 noeuds.
