	...
	public static void main(String[] args) {
		...
		try {
			...
			if ((msgTokenizer.nextToken()).equals("Blanc")) {
				System.out.println("Je suis Blanc, c'est é moi de jouer.");
				maCouleur = BLANC;
			} else { // doit etre égal é "Noir"
			...
			do {
				...
				if (firstToken.equals("FIN!")) {
					...
					if (theWinnerIs.equals("Blanc")) {
						...
						if (theWinnerIs.equals("Noir")) couleurAJouer = NOIR;
						else couleurAJouer = VIDE;
					}

					if (couleurAJouer == maCouleur) System.out.println("J'ai gagné!");
					...
					// On lit ce que joue le joueur et on l'envoie é l'autre
